...
class BooruDB:
    ...
    def __init__(self, db_path="../data/gelbooru.db"):
    ...
    def insert_view(self, booru_view):
        ...
        self._cur.executemany("INSERT OR IGNORE INTO tag VALUES (?)", val_tag)
        val_tagged = ((booru_view.uid, tag) for tag in booru_view.tags)
        self._cur.executemany("INSERT OR IGNORE INTO tagged VALUES (?,?)", val_tagged)
        self._con.commit()
